...
const aboutContent = {
  ...
  second:
    "Urozmaicony teren, czyste lasy i jeziora, rezerwaty przyrody, wiele malowniczych zakątków oraz brak większych miast i przemysłu sprawiają, że okolica stanowi idealne miejsce na wypoczynek, jednocześnie wciąż pozostając nieodkrytą przez masową turystykę. Jezioro Strażym (73 ha) stanowi część głównego szlaku wodnego łączącego całe Pojezierze Brodnickie.",
};
...
const AboutHeader = () => {
  return (
    <div className="flex flex-col mx-auto max-w-screen-lg gap-8 px-4">
