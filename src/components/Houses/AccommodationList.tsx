...
export const AccommodationList = ({ type }: Props) => {
    ...
    <div className="min-h-screen max-w-screen-lg py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          Odkryj nasze komfortowe {typeText.toLocaleLowerCase()} w pięknym
          otoczeniu natury
        </p>

        {/* Accommodation listing - now as a list instead of cards */}
        {accommodationList.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-lg text-gray-600">
              Nie znaleziono noclegów spełniających kryteria wyszukiwania
            </p>
          </div>
        ) : (
