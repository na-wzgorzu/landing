export const attractions = [
  ...
  {
    id: 9,
    name: "Jajkowo - Wioska Początku Życia",
    description:
      "Oddalona o 9 km od ośrodka organizacja z Pojezierza Brodnickiego oferująca zabawy i zajęcia edukacyjne dla grup dziecięcych i młodzieżowych. W programie warsztaty malowania jajek, gry i poczęstunek.",
    link: "https://wioska-tematyczna.pl/project/jajkowo-wioska-poczatku-zycia/",
  },
  {
    id: 10,
    name: "Kurza Góra",
    description:
      "Położony 25 km od ośrodka całoroczny obiekt w Kurzętniku oferujący zimą największą stację narciarską w północnej Polsce, a przez cały rok wieżę widokową i kompleks tubingowy. Posiada również Bike Park.",
    link: "https://kurzagora.pl/",
  },
  {
    id: 4,
    name: "Ruiny Zamku Krzyżackiego w Kurzętniku",
    description:
